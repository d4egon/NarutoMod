...
namespace NarutoMod
{
    public class WorkGiver_MeditationSpot_Sage : WorkGiver_Scanner
    {
        public override ThingRequest PotentialWorkThingRequest => ThingRequest.ForDef(DefDatabase<ThingDef>.GetNamed("NM_MeditationSpot_Sage"));
